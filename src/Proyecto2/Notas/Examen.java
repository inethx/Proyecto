...
public class Examen {
    ...
    public Examen(PadreFamiliar padreFamiliar, MadreFamiliar madreFamiliar, Alumno alumno, int nota, int puntosTotal, int puntosObtenidos, Date fecha) {
        this.padreFamiliar = padreFamiliar;
        this.madreFamiliar = madreFamiliar;
        this.alumno = alumno;
        this.nota = nota;
    ...
    public String toString() {
        return "Examen{"+ "nombre=" + alumno.getNombre()+" "+alumno.getApellido() +", padre="+padreFamiliar.getNombrePadre()+" "+padreFamiliar.getApellidoPadre()+", madre="+madreFamiliar.getNombreMadre()+" "+madreFamiliar.getApellidoMadre()+  ", nota=" + nota + ", puntosTotal=" + puntosTotal + ", puntosObtenidos=" + puntosObtenidos + '}';
    }
